...
ROOT_DIRECTORY = "/Users/shanemattner/Desktop/schematic_scraper"
...
- wire_conn_test.kicad_sch: Example KiCad schematic file for a mid-complexity circuit with unecessarily long and winding wires to test the script
- wire_conn_test_output.txt: Output file generated by kiutils_test.py for a mid-complexity circuit


The logic works for calculating pin locations and calculating netlists for a circuit design tool.

The logic for connecting local labels from various parts does not work.  ie `divider_2` label should connect R7_pin2, R8_pin1, and J2_pin3.
