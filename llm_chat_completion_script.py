...
kicad_writer.py works well for other parts and generates schematics properly. However, for 
the NCP1117-3.3 part, it generates an incorrect schematic. The _3v3_regulator.kicad_sch file
...
Please help me figure out why the kicad_writer.py script is generating an incorrect schematic.
The issue likely stems from the "(extends "AP1117-15") line in the definition. Please modify the logic
to accomodate any extended parts.

Do not hard code any solutions, always assume we are using this logic for many thousands of parts.
Try to generate as simple of a solution as possible.

Please help me plan the solution and do not generate any code yet.

Update the SCH_GEN_ISSUE_SUMMARY.md file with your thoughts.
